...
class CurrentWeatherTest extends UnitTestCase {
  ...
  public function testApiRequest() {
    ...
    $test_data_response = '<div class="weather-wrapper"><h2>Weather for Lviv</h2><div>Lviv (UA <img src="https://openweathermap.org/images/flags/ua.png">)</div><div>Clear (clear sky)</div><div><img src="https://openweathermap.org/img/wn/01d.png"></div><div>12.21ºC</div><div>11.11ºC</div><div>62%</div><div>1024hPa</div></div>';
